...
Edge aggregation can also be used to obtain aggregated multigraphs. Assume that we study a graph with three different types of relations over three periods of time:
