...
#' @details When using the IEAS model: the edge assignment probabilities are estimated by using the observed edge multiplicities
...
#' When using the ISA model: The stub assignment probabilities are estimated by using
