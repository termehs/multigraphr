...
#' @details  The probability distributions of all unique multigraphs given fixed degree sequence, together with the first two moments and interval estimates of the statistics M1 = ‘number of loops’ and M2 = ‘number of multiple edges’ under the RSM model are calculated.
