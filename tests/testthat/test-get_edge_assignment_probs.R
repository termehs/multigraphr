test_that("get_edge_assignment_probs works", {
  ...
  iseas_correct <- c(0.05, 0.133333333333333, 0.133333333333333, 0.133333333333333,
                     0.05, 0.133333333333333, 0.133333333333333, 0.05, 0.133333333333333,
                     0.05)
  isa_correct <- c(0.16, 0.16, 0.08, 0.08, 0.08, 0.08, 0.04, 0.04, 0.04, 0.04,
                   0.04, 0.01, 0.02, 0.02, 0.02, 0.01, 0.02, 0.02, 0.01, 0.02, 0.01
  )

  expect_equal(iseas,iseas_correct)
  expect_equal(isa,isa_correct)
